...
delingwei（以下简称 “delingwei”）提供的小说阅读软件及服务（以下简称“本软件”、“小说阅读器”或“本服务”），您应当阅读并遵守《小说阅读软件用户个人信息保护及隐私政策协议》（以下简称“本协议”）。
...
除非您已阅读并接受本协议所有条款，否则您无权使用本软件及相关服务。您的使用、登录等行为即视为您已阅读并同意上述协议的约束。
   ...
   本协议下的条款可由delingwei随时变更，用户须定期审阅本协议。协议条款一旦发生变动，delingwei将会在本页面进行更新，并在“小说阅读软件”相关的页面上提示变更内容。变更后的协议一经公布即有效代替原来的协议。用户如不同意delingwei对本协议所作的任何变更，应立即停止使用delingwei提供的甜橙小说阅读软件及服务。如用户在本协议变更后继续使用小说阅读软件及服务，即视作用户已完全同意变更后的协议。用户可随时在本页面查阅最新用户个人信息保护及隐私政策。
...
1.1小说阅读软件：是指经营者delingwei向用户提供的读书工具（以下简称"小说软件"），支持导入外部文档和软件内置书城书籍的阅读，同时为用户提供包括但不限于书籍推荐、读书笔记、好友分享等功能或内容的软件许可及服务的客户端软件。
